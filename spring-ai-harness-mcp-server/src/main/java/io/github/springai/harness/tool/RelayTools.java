...
public class RelayTools {
	...
	@McpTool(name = "browser_close", description = "Close the page")
	public CallToolResult browserClose(McpTransportContext context) {
		return relayCall(context, "browser_close", Map.of());
	}

	@McpTool(name = "browser_resize", description = "Resize the browser window")
	...
	@McpTool(name = "browser_console_messages", description = "Returns all console messages")
	...
	@McpTool(name = "browser_handle_dialog", description = "Handle a dialog")
	...
	@McpTool(name = "browser_file_upload", description = "Upload one or multiple files")
	...
	@McpTool(name = "browser_press_key", description = "Press a key on the keyboard")
	...
	@McpTool(name = "browser_navigate", description = "Navigate to a URL")
	...
	@McpTool(name = "browser_navigate_back", description = "Go back to the previous page")
	...
	@McpTool(name = "browser_navigate_forward", description = "Go forward to the next page")
	...
	@McpTool(name = "browser_network_requests", description = "Returns all network requests since loading the page")
	...
	@McpTool(name = "browser_pdf_save", description = "Save page as PDF")
	...
	@McpTool(name = "browser_take_screenshot", description = "Take a screenshot of the current page. You can't perform actions based on the screenshot, use browser_snapshot for actions.")
	...
	@McpTool(name = "browser_snapshot", description = "Capture accessibility snapshot of the current page, this is better than screenshot")
	public CallToolResult browserSnapshot(McpTransportContext context) {
		return relayCall(context, "browser_snapshot", Map.of());
	}

	@McpTool(name = "browser_click", description = "Perform click on a web page")
	...
	@McpTool(name = "browser_drag", description = "Perform drag and drop between two elements")
	...
	@McpTool(name = "browser_hover", description = "Hover over element on page")
	...
	@McpTool(name = "browser_type", description = "Type text into editable element")
	...
	@McpTool(name = "browser_select_option", description = "Select an option in a dropdown")
	...
	@McpTool(name = "browser_tab_list", description = "List browser tabs")
	public CallToolResult browserTabList(McpTransportContext context) {
		return relayCall(context, "browser_tab_list", Map.of());
	}

	@McpTool(name = "browser_tab_new", description = "Open a new tab")
	...
	@McpTool(name = "browser_tab_select", description = "Select a tab by index")
	...
	@McpTool(name = "browser_tab_close", description = "Close a tab")
	...
	@McpTool(name = "browser_wait_for", description = "Wait for text to appear or disappear or a specified time to pass")
	...
	@McpTool(name = "run_ipython_cell", description = "Execute code in a stateful IPython (Jupyter) kernel and return stdout/stderr.")
	...
	@McpTool(name = "run_shell_command", description = "Execute a shell command and return stdout/stderr/returncode.")
