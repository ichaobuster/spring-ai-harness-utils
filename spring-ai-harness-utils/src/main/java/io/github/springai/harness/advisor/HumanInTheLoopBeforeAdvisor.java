 ...
 */
@Slf4j
public class HumanInTheLoopBeforeAdvisor implements BaseChatMemoryAdvisor {
    ...
    private HumanInTheLoopBeforeAdvisor(ChatMemory chatMemory, int order, Set<String> needPermissionTools, ToolCallingManager toolCallingManager) {
    ...
    public static final class Builder {
        ...
        public HumanInTheLoopBeforeAdvisor build() {
            return new HumanInTheLoopBeforeAdvisor(this.chatMemory, this.order, this.needPermissionTools, this.toolCallingManager);
        }
