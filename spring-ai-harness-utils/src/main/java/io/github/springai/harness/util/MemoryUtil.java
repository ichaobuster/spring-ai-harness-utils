...
public class MemoryUtil {
	...
	public static final String DEFAULT_MEMORY_SYSTEM_PROMPT_TEMPLATE = """
			# Auto Memory
			   
			You have a persistent memory system backed by the AutoMemoryTools.
	...
	public static final String DEFAULT_TYPES_OF_MEMORY = """
			<types>
			<type>
			    <name>user</name>
	...
	public static final String DEFAULT_WHAT_NOT_TO_SAVE_IN_MEMORY = """
	...
	/**
	 * 创建 AutoMemroyTools 的系统提示词
	 *
	 * @param memorySystemPromptTemplate 系统提示词模板，需要有 {TYPES_OF_MEMORY} 和 {WHAT_NOT_TO_SAVE_IN_MEMORY} ，默认使用 DEFAULT_MEMORY_SYSTEM_PROMPT_TEMPLATE
	 * @param typesOfMemory              需要记住的内容类型，默认使用 DEFAULT_TYPES_OF_MEMORY
	 * @param whatNotToSaveInMemory      不需要记住的内容，默认使用 DEFAULT_WHAT_NOT_TO_SAVE_IN_MEMORY
	 * @return 系统提示词
	 */
	public static String createAutoMemoryToolsSystemPrompt(String memorySystemPromptTemplate, String typesOfMemory, String whatNotToSaveInMemory) {
		return PromptTemplate.builder()
				.template(memorySystemPromptTemplate)
				.variables(Map.of(
						"TYPES_OF_MEMORY", typesOfMemory,
						"WHAT_NOT_TO_SAVE_IN_MEMORY", whatNotToSaveInMemory
				))
				.build()
				.render();
	}
	...
	/**
	 * 获取默认 AutoMemroyTools 的系统提示词
	 *
	 * @return 默认系统提示词
	 */
	public static String getDefaultAutoMemoryToolsSystemPrompt() {
		return createAutoMemoryToolsSystemPrompt(DEFAULT_MEMORY_SYSTEM_PROMPT_TEMPLATE, DEFAULT_TYPES_OF_MEMORY, DEFAULT_WHAT_NOT_TO_SAVE_IN_MEMORY);
	}
